...
const App = () => {
  // Calling useState function will return an array of two elements
  // [currentState, function to update the currentState]
  // Whenever we update the currentState the component will rerender with the new state
...
// Take the value of the property with the same name
